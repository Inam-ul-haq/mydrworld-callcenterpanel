...
<head>
        ...
        <meta charset="utf-8" />
        <title>Call Center Panel | Mydrworld</title>
            ...
            <div class="d-flex">
                            ...
                            <a href="appointment-details-pending.php" class="text-reset notification-item">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div>
                                            <p class="mb-0">DR S.K SHETTY M.S has received a pending appointment request from John Doe for 05 May 2024 at 09:30AM at Aster Hospital, Falcon House.</p>
                                        </div>
                                    </div>
                                </div>
                            </a>
                            <a href="appointment-details-confirmed.php" class="text-reset notification-item">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <h6 class="mb-1">John Doe</h6>
                                        <div>
                                            <p class="mb-0">DR S.K SHETTY M.S appointment with Joh Doe at Aster Hospital, Falcon House on 05 May 2024 at 09:30AM has been confirmed.</p>
                                        </div>
                                    </div>
                                </div>
                            </a>
                            <a href="appointment-details-rescheduled.php" class="text-reset notification-item">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <h6 class="mb-1">John Doe</h6>
                                        <div>
                                            <p class="mb-0">DR S.K SHETTY M.S appointment with Joh Doe at Aster Hospital, Falcon House has been rescheduled to 06 May 2024 at 09:30AM.</p>
                                        </div>
                                    </div>
                                </div>
                            </a>
                            <a href="appointment-details-cancelled.php" class="text-reset notification-item">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <h6 class="mb-1">John Doe</h6>
                                        <div>
                                            <p class="mb-0">DR S.K SHETTY M.S appointment with Joh Doe at Aster Hospital, Falcon House on 05 May 2024 at 09:30AM has been cancelled due to Doctor Unavailability.</p>
                                        </div>
                                    </div>
                                </div>
                            </a>
                            <a href="appointment-details-completed.php" class="text-reset notification-item">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <h6 class="mb-1">John Doe</h6>
                                        <div>
                                            <p class="mb-0">DR S.K SHETTY M.S appointment with Joh Doe at Aster Hospital, Falcon House on 05 May 2024 at 09:30AM has been successfully completed.</p>
                                        </div>
                                    </div>
                                </div>
                            </a>
                ...
                <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item user text-start d-flex align-items-center" id="page-header-user-dropdown"
                            ...
                            alt="Header Avatar">
                            <span class="d-none d-xl-inline-block ms-2 fw-medium font-size-15 text-primary">Aladin Call Centre</span>
                        </button>
                        <div class="dropdown-menu dropdown-menu-end pt-0">
                            <div class="p-3 border-bottom">
                                <h6 class="mb-0 text-black">Aladin Call Centre</h6>
                                <p class="mb-0 font-size-11 text-muted">test@gmail.com</p>
                            </div>

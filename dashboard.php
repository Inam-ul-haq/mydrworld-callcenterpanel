...
<div class="row">
    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <a href="agents.php" class="card bg-white">
            <div class="card-body">
                <div>
                    ...
                    <div class="d-flex align-items-center">
                        <div class="avatar">
                            <div class="avatar-title rounded bg-primary">
                                <i class="fi fi-rr-user-check icon font-size-22 mb-0 text-white" style="top:2px !important"></i>
                            </div>
                        </div>

                        <div class="flex-grow-1 ms-3">
                            <h6 class="mb-0 font-size-15">Active Agents</h6>
                        </div>
                    </div>
                    <div>
                        <h4 class="mt-2 pt-1 mb-0 h1">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="avatar">
                            <div class="avatar-title rounded bg-warning">
                                <i class="fi fi-rr-user-minus icon font-size-22 mb-0 text-black" style="top:2px !important"></i>
                            </div>
                        </div>

                        <div class="flex-grow-1 ms-3">
                            <h6 class="mb-0 font-size-15">Inactive Agents</h6>
                        </div>
                    </div>
                    <div>
                        <h4 class="mt-2 pt-1 mb-0 h1">

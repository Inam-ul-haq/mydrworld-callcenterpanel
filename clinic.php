...
<div class="card">
    <div class="card-header card-header d-flex justify-content-between">
        <a href="edit-clinic.php" class="btn btn-primary w-auto ml-auto"> Add Clinic</a>
    </div>
                    ...
                    <table id="base-style" class="table table-striped table-bordered align-middle w-100">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>UAE</td>
                                <td>
                                    <!-- <a class="btn btn-sm btn-icon btn-secondary text-white" href="clinic-details.php">
                                    ...
                                    <div class="dropdown mt-4 mt-sm-0">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item complete-link" href="clinic-details.php">View Profile </a>
                                            <a class="dropdown-item cancel-link" href="edit-clinic.php">Edit Profile</a>
                                            <a class="dropdown-item complete-link" href="#!">Delete Profile</a>
                                            <a class="dropdown-item complete-link" href="clinic-insurance.php">View Insurances</a>
                                            <a class="dropdown-item complete-link" href="clinic-locations.php">View Location</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td>Al Raas Private Medical Clinic</td>

    ...
    <div class="card-body">
        <div class="position-relative">
            <div class="d-flex gap-2 justify-content-end mb-3">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#appointment-modal" fdprocessedid="j3zd0c">Make an Appointment</button>
            </div>
            ...
            <div class="row align-items-end">
                ...
                <div class="col-lg-3 col-md-6 mb-3">
                    <label class="form-label" for="username">Select Agent</label>
                    <div class="position-relative select-custom-icon">
                        <select name="" id="" class="select2-single" data-placeholder="Select Agent">
                            <option></option>
                    ...
                    <table class="table table-striped table-bordered align-middle" id="example2">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>#MYDW1025</td>
                                <td>
                                    <a href="#!" class="patient-link"><img src="assets/images/user.png" width="32" height="32" class="me-2" alt="" />John Doe</a>
                                </td>
                                <td>09:30 AM</td>
                                <td><a href="view-doctor.php">DR S.K SHETTY M.S</a> </td>
                                <td>Agent 1</td>
                                <td><div class="status-badge pending-badge"><span></span> Pending</div></td>
                                <td>04-04-2024</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>09:30 AM</td>
                                <td><a href="view-doctor.php">DR SHAMIM SALIM</a></td>
                                <td>Agent 1</td>
                                <td><div class="status-badge reschedule-badge"><span></span> Re Scheduled</div></td>
                                <td>04-04-2024</td>
                                <td>
                                    <div class="dropdown mt-4 mt-sm-0">
                                        <button class="btn btn-light btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <tr>
                                ...
                                <td><a href="view-doctor.php">DR S.K SHETTY M.S</a></td>
                                <td>Agent 1</td>
                                <td><div class="status-badge completed-badge"><span></span> Completed</div></td>
                                <td>04-04-2024</td>
                                <td>
                                    <div class="dropdown mt-4 mt-sm-0">
                            ...
                            <tr>
                                ...
                                <td><a href="view-doctor.php">DR SHAMIM SALIM</a></td>
                                <td>Agent 1</td>
                                <td><div class="status-badge cancelled-badge"><span></span> Cancelled</div></td>
                                <td>04-04-2024</td>
                                <td>
                                    <div class="dropdown mt-4 mt-sm-0">
                                        <button class="btn btn-light btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <tr>
                                ...
                                <td><a href="view-doctor.php">DR S.K SHETTY M.S</a></td>
                                <td>Agent 1</td>
                                <td><div class="status-badge confirmed-badge"><span></span> Confirmed</div></td>
                                <td>04-04-2024</td>
                                <td>
                                    <div class="dropdown mt-4 mt-sm-0">
                                        <button class="btn btn-light btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="card-h-100 my-3">
                    <div>
                        ...
                        <div class="single-doctor-appointment mb-4">
                            <div class="d-flex align-items-center gap-2 mb-3">
                                <div class="flex-shrink-0 me-3">
                                    <img style="width: 60px; height: 60px; border-radius: 5px;" src="assets/images/doctor.jpg" alt="Generic placeholder image" />
                                </div>
                                <div class="flex-grow-1">
                                    <h4 class="font-size-20 mb-2">DR S.K SHETTY M.S</h4>
                                    <h6 class="font-size-13 mb-0 text-primary">ORTHOPIDIC SURGEON</h6>
                                </div>
                            </div>
                        ...
                        <div class="single-doctor-appointment mb-4">
                            <div class="d-flex align-items-center gap-2 mb-3">
                                <div class="flex-shrink-0 me-3">
                                    <img style="width: 60px; height: 60px; border-radius: 5px;" src="assets/images/doctor1.webp" alt="Generic placeholder image" />
                                </div>
                                <div class="flex-grow-1">
                                    <h4 class="font-size-20 mb-2">DR SHAMIM SALIM</h4>
                                    <h6 class="font-size-13 mb-0 text-primary">ORTHOPIDIC SURGEON</h6>
                                </div>
                            </div>
                            <div class="section-area-grid-view d-flex flex-wrap">

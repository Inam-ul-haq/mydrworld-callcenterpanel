                    ...
                    <form action="" class="custom-form">
                        <div class="row">
                            <div class="col-12 mb-3">
                                <label class="form-label" for="">Clinic/Hospital </label>
                                ...
                                <div class="position-relative input-custom-icon">
                                    <input type="text" class="form-control" id="" value="Boston Dental Center" disabled placeholder="Clinic/Hospital">
...
<!-- Modal -->
<div class="modal fade" id="reschedule-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form action="" class="custom-form">
                    <div class="row">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <div class="position-relative">
                                <select name="" id="DepartmentSelect" class="select2-single" data-placeholder="Select Department">
                                    <option></option>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#PatientSelct, #DocSelct, #ClinicSelect, #DepartmentSelect").select2({ dropdownParent: "#appointment-modal" });
        $("#PatientSelct1").select2({ dropdownParent: "#appointment-modal-doctor" });
    });
</script>
</body>

...
<head>
        ...
        <meta charset="utf-8" />
        <title>Call Center Login | Mydrworld</title>
                        ...
                        <div class="card overflow-hidden">
                            <div class="card-body p-4"> 
                                <!-- <div class="text-center mb-4 title-card" style="position: absolute; width: 100%; left: 0; top: 0; padding: 15px; background: #FF416F;">
                                    <h3 class="mb-0 text-white font-size-24">Call Center Panel</h3>
                                </div> -->
                                <div class="mb-4 pb-2">
                                ...
                                <div class="text-center mt-2">
                                    <h5>Welcome Back !</h5>
                                    <p class="text-black">Sign in to continue to Call Center Panel.</p>
                                </div>
                                <div class="p-2 mt-4">
